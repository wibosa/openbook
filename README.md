...
* ubuntu instals llilypond 2.22 which fails on the newer lilypond syntax for /alternative
* so work around to install  binary package in /opt/lilypond2.24.4 and set the PATH alike
* install lilypond LTS version 2.24.4 binary package in /opt
* @see instructions for installing binary package without apt tooling https://apetenchea.github.io/2021/10/17/installing-prebuilt-binaries-in-ubuntu/
